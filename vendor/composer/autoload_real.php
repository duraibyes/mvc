...
class ComposerAutoloaderInitf8c46527eb1f36e996b85b831974516f
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitf8c46527eb1f36e996b85b831974516f::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiref8c46527eb1f36e996b85b831974516f($fileIdentifier, $file);
        }
...
function composerRequiref8c46527eb1f36e996b85b831974516f($fileIdentifier, $file)
{
